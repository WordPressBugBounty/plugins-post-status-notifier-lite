 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwPsn_Vendor_Zend_Validate_Isbn extends IfwPsn_Vendor_Zend_Validate_Abstract
{
    const AUTO    = 'auto';
    const ISBN10  = '10';
    const ISBN13  = '13';
     ...
     * Set up options.
     *
     * @param  IfwPsn_Vendor_Zend_Config|array $options
     * @throws IfwPsn_Vendor_Zend_Validate_Exception When $options is not valid
     */
    public function __construct($options = array())
    {
        ...
        if (!is_array($options)) {
            /**
             * @see IfwPsn_Vendor_Zend_Validate_Exception
             */
            require_once IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Validate/Exception.php';
            throw new IfwPsn_Vendor_Zend_Validate_Exception('Invalid options provided.');
        }
     ...
     * @throws IfwPsn_Vendor_Zend_Validate_Exception When $separator is not valid
     * @return IfwPsn_Vendor_Zend_Validate_Isbn Provides a fluent interface
     */
    public function setSeparator($separator)
    {
        ...
        if (!in_array($separator, array('-', ' ', ''))) {
             ...
             */
            require_once IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Validate/Exception.php';
            throw new IfwPsn_Vendor_Zend_Validate_Exception('Invalid ISBN separator.');
        }
     ...
     *
     * @param  string $type
     * @throws IfwPsn_Vendor_Zend_Validate_Exception When $type is not valid
     * @return IfwPsn_Vendor_Zend_Validate_Isbn Provides a fluent interface
     */
    public function setType($type)
    {
        ...
        if (!in_array($type, array(self::AUTO, self::ISBN10, self::ISBN13))) {
             ...
             */
            require_once IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Validate/Exception.php';
            throw new IfwPsn_Vendor_Zend_Validate_Exception('Invalid ISBN type');
        }
