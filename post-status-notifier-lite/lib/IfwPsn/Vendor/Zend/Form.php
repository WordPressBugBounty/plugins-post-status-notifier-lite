...
class IfwPsn_Vendor_Zend_Form implements Iterator, Countable, IfwPsn_Vendor_Zend_Validate_Interface
{
     ...
     * @var string
     */
    protected $_defaultDisplayGroupClass = 'IfwPsn_Vendor_Zend_Form_DisplayGroup';
    ...
    public function __clone()
    {
        ...
        foreach ($this->_displayGroups as $group)  {
            /** @var IfwPsn_Vendor_Zend_Form_DisplayGroup $clone */
            $clone    = clone $group;
            $elements = array();
    ...
    {
        /** @var IfwPsn_Vendor_Zend_Form_Element $element */
        foreach ($this->getElements() as $element) {
            $element->setValue(null);
        }
        /** @var IfwPsn_Vendor_Zend_Form_SubForm $subForm */
    ...
    public function setOptions(array $options)
    {
        ...
        foreach ($options as $key => $value) {
            ...
            if (method_exists($this, $method)) {
                if($normalized == 'View' && !($value instanceof IfwPsn_Vendor_Zend_View_Interface)) {
                    continue;
                }
                $this->$method($value);
            } else {
     ...
     *
     * @param  IfwPsn_Vendor_Zend_Loader_PluginLoader_Interface $loader
     * @param  string $type 'decorator' or 'element'
     * @return IfwPsn_Vendor_Zend_Form
     * @throws IfwPsn_Vendor_Zend_Form_Exception on invalid type
     */
    public function setPluginLoader(IfwPsn_Vendor_Zend_Loader_PluginLoader_Interface $loader, $type = null)
    {
        ...
        switch ($type) {
            ...
            default:
                ...
                throw new IfwPsn_Vendor_Zend_Form_Exception(sprintf('Invalid type "%s" provided to setPluginLoader()', $type));
        }
    }
    ...
    public function getPluginLoader($type = null)
    {
        ...
        if (!isset($this->_loaders[$type])) {
            switch ($type) {
                ...
                default:
                    require_once IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Form/Exception.php';
                    throw new IfwPsn_Vendor_Zend_Form_Exception(sprintf('Invalid type "%s" provided to getPluginLoader()', $type));
            }

            require_once IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Loader/PluginLoader.php';
            $this->_loaders[$type] = new IfwPsn_Vendor_Zend_Loader_PluginLoader(
                array('IfwPsn_Vendor_Zend_' . $prefixSegment . '_' => 'IfwPsn/Vendor/Zend/' . $pathSegment . '/')
            );
        }
     ...
     * @param  string $type
     * @return IfwPsn_Vendor_Zend_Form
     * @throws IfwPsn_Vendor_Zend_Form_Exception for invalid type
     */
    ...
    public function addDisplayGroupPrefixPath($prefix, $path)
    {
        ...
        /** @var IfwPsn_Vendor_Zend_Form_DisplayGroup $group */
    ...
    public function setMethod($method)
    {
        ...
        if (!in_array($method, $this->_methods)) {
            require_once IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Form/Exception.php';
            throw new IfwPsn_Vendor_Zend_Form_Exception(sprintf('"%s" is an invalid form method', $method));
        }
    ...
    public function setName($name)
    {
        ...
        if ('' === (string)$name) {
            require_once IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Form/Exception.php';
            throw new IfwPsn_Vendor_Zend_Form_Exception('Invalid name provided; must contain only valid variable characters and be non-empty');
        }
     ...
     * IfwPsn_Vendor_Zend_Form_Element. If a string element type is provided, $name must be
     * provided, and $options may be optionally provided for configuring the
     * element.
     *
     * If a IfwPsn_Vendor_Zend_Form_Element is provided, $name may be optionally provided,
     * and any provided $options will be ignored.
     *
     * @param  string|IfwPsn_Vendor_Zend_Form_Element $element
     * @param  string $name
     * @param  array|IfwPsn_Vendor_Zend_Config $options
     * @throws IfwPsn_Vendor_Zend_Form_Exception on invalid element
     * @return IfwPsn_Vendor_Zend_Form
     */
    public function addElement($element, $name = null, $options = null)
    {
        if (is_string($element)) {
            ...
            require_once IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Form/Exception.php';
            throw new IfwPsn_Vendor_Zend_Form_Exception(
                'Element must be specified by string or IfwPsn_Vendor_Zend_Form_Element instance'
            );
        }
    ...
    public function createElement($type, $name, $options = null)
    {
        if (!is_string($type)) {
            require_once IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Form/Exception.php';
            throw new IfwPsn_Vendor_Zend_Form_Exception('Element type must be a string indicating type');
        }

        if (!is_string($name)) {
            require_once IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Form/Exception.php';
            throw new IfwPsn_Vendor_Zend_Form_Exception('Element name must be a string');
        }
    ...
    public function addElements(array $elements)
    {
        foreach ($elements as $key => $spec) {
            ...
            if (is_string($spec) || ($spec instanceof IfwPsn_Vendor_Zend_Form_Element)) {
     ...
     *
     * @param  string $name
     * @return IfwPsn_Vendor_Zend_Form_Element|null
     */
    ...
    public function setDefaults(array $defaults)
    {
        ...
        /** @var IfwPsn_Vendor_Zend_Form_SubForm $form */
     ...
     * @return IfwPsn_Vendor_Zend_Form
     */
    public function addSubForm(IfwPsn_Vendor_Zend_Form $form, $name, $order = null)
    {
        $name = (string) $name;
        /** @var IfwPsn_Vendor_Zend_Loader_PluginLoader $loader */
    ...
    public function addSubForms(array $subForms)
    {
        foreach ($subForms as $key => $spec) {          
            $name = (string) $key;
            if ($spec instanceof IfwPsn_Vendor_Zend_Form) {
            ...
            if (is_array($spec)) {
                ...
                switch ($argc) {
                    ...
                    case (1 <= $argc):
                        ...
                        if (!$subForm instanceof IfwPsn_Vendor_Zend_Form) {
                            $subForm = new IfwPsn_Vendor_Zend_Form_SubForm($subForm);
                        }
                    case (2 <= $argc):
                        $name  = array_shift($spec);
                    case (3 <= $argc):
     ...
     *
     * @param  string $name
     * @return IfwPsn_Vendor_Zend_Form|null
     */
     ...
     *
     * @param  IfwPsn_Vendor_Zend_Form_DisplayGroup $group
     * @param  string|null            $name
     * @throws IfwPsn_Vendor_Zend_Form_Exception
     * @return IfwPsn_Vendor_Zend_Form
     */
    protected function _addDisplayGroupObject(IfwPsn_Vendor_Zend_Form_DisplayGroup $group, $name = null)
    {
        if (null === $name) {
            $name = $group->getName();
            if ('' === (string)$name) {
                require_once IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Form/Exception.php';
                throw new IfwPsn_Vendor_Zend_Form_Exception('Invalid display group added; requires name');
            }
        }
    ...
    public function addDisplayGroups(array $groups)
    {
        foreach ($groups as $key => $spec) {
            ...
            if ($spec instanceof IfwPsn_Vendor_Zend_Form_DisplayGroup) {
     ...
     *
     * @param  string $name
     * @return IfwPsn_Vendor_Zend_Form_DisplayGroup|null
     */
    ...
    public function getElementsAndSubFormsOrdered()
    {
        ...
        foreach ($this->_order as $name => $order) {
            ...
            if ($this->$name instanceof IfwPsn_Vendor_Zend_Form_Element ||
                $this->$name instanceof IfwPsn_Vendor_Zend_Form) {
                array_splice($ordered, $order, 0, array($this->$name));
            } else if ($this->$name instanceof IfwPsn_Vendor_Zend_Form_DisplayGroup) {
                $subordered = array();
                /** @var IfwPsn_Vendor_Zend_Form_Element $element */
    ...
    public function isValid($data)
    {
        if (!is_array($data)) {
            require_once IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Form/Exception.php';
            throw new IfwPsn_Vendor_Zend_Form_Exception(__METHOD__ . ' expects an array');
        }
     ...
     *
     * @return IfwPsn_Vendor_Zend_View_Interface|null
     */
     ...
     * @return IfwPsn_Vendor_Zend_Form_Decorator_Interface
     */
     ...
     *
     * @param  string|IfwPsn_Vendor_Zend_Form_Decorator_Interface $decorator
     * @param  array|IfwPsn_Vendor_Zend_Config                    $options Options with which to initialize decorator
     * @throws IfwPsn_Vendor_Zend_Form_Exception
     * @return IfwPsn_Vendor_Zend_Form
     */
    public function addDecorator($decorator, $options = null)
    {
        if ($decorator instanceof IfwPsn_Vendor_Zend_Form_Decorator_Interface) {
            ...
            if (is_numeric($name)) {
                require_once IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Form/Exception.php';
                throw new IfwPsn_Vendor_Zend_Form_Exception('Invalid alias provided to addDecorator; must be alphanumeric string');
            }
            if (is_string($spec)) {
                $decorator = array(
                    'decorator' => $spec,
            ...
            } elseif ($spec instanceof IfwPsn_Vendor_Zend_Form_Decorator_Interface) {
                $decorator = $spec;
            }
        } else {
            require_once IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Form/Exception.php';
            throw new IfwPsn_Vendor_Zend_Form_Exception('Invalid decorator provided to addDecorator; must be string or IfwPsn_Vendor_Zend_Form_Decorator_Interface');
        }
    ...
    public function addDecorators(array $decorators)
    {
        foreach ($decorators as $decoratorName => $decoratorInfo) {
            if (is_string($decoratorInfo) ||
                $decoratorInfo instanceof IfwPsn_Vendor_Zend_Form_Decorator_Interface) {
                ...
                require_once IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Form/Exception.php';
                throw new IfwPsn_Vendor_Zend_Form_Exception('Invalid decorator passed to addDecorators()');
            }
        }
     ...
     *
     * @param  string $name
     * @return false|IfwPsn_Vendor_Zend_Form_Decorator_Abstract
     */
    ...
    public function render(IfwPsn_Vendor_Zend_View_Interface $view = null)
    {
        ...
        $content = '';
        /** @var IfwPsn_Vendor_Zend_Form_Decorator_Abstract $decorator */
     ...
     *
     * @return IfwPsn_Vendor_Zend_Translate|null
     */
     ...
     *
     * @param  string $name
     * @return IfwPsn_Vendor_Zend_Form_Element|IfwPsn_Vendor_Zend_Form|null
     */
     ...
     *
     * @param  string $name
     * @param  IfwPsn_Vendor_Zend_Form_Element|IfwPsn_Vendor_Zend_Form $value
     * @return void
     * @throws IfwPsn_Vendor_Zend_Form_Exception for invalid $value
     */
    public function __set($name, $value)
    {
        if ($value instanceof IfwPsn_Vendor_Zend_Form_Element) {
            $this->addElement($value, $name);
            return;
        } elseif ($value instanceof IfwPsn_Vendor_Zend_Form) {
        ...
        throw new IfwPsn_Vendor_Zend_Form_Exception('Only form elements and groups may be overloaded; variable of type "' . $type . '" provided');
    }
     ...
     * @param  array $args
     * @return string
     * @throws IfwPsn_Vendor_Zend_Form_Exception for invalid decorator or invalid method call
     */
    public function __call($method, $args)
    {
        if ('render' == substr($method, 0, 6)) {
            ...
            require_once IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Form/Exception.php';
            throw new IfwPsn_Vendor_Zend_Form_Exception(sprintf('Decorator by name %s does not exist', $decoratorName));
        }

        require_once IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Form/Exception.php';
        throw new IfwPsn_Vendor_Zend_Form_Exception(sprintf('Method %s does not exist', $method));
    }
     ...
     *
     * @throws IfwPsn_Vendor_Zend_Form_Exception
     * @return IfwPsn_Vendor_Zend_Form_Element|IfwPsn_Vendor_Zend_Form_DisplayGroup|IfwPsn_Vendor_Zend_Form
     */
    ...
    public function current()
    {
        ...
        if (isset($this->_elements[$key])) {
            ...
            require_once IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Form/Exception.php';
            throw new IfwPsn_Vendor_Zend_Form_Exception(sprintf('Corruption detected in form; invalid key ("%s") found in internal iterator', (string) $key));
        }
    }
        ...
        if ($this->_orderUpdated) {
            ...
            foreach ($this->_order as $key => $order) {
                if (null === $order) {
                    ...
                    throw new IfwPsn_Vendor_Zend_Form_Exception('Form elements ' .
                        $items[$order] . ' and ' . $key .
                        ' have the same order (' .
                        $order . ') - ' .
