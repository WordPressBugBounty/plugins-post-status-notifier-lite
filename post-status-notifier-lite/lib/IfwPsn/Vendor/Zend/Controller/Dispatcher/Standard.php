 ...
 * @version    $Id: Standard.php 3174969 2024-10-24 12:26:47Z worschtebrot $
 */

/** IfwPsn_Vendor_Zend_Loader */
require_once IFW_PSN_LIB_ROOT . 'IfwPsn/Zend/Loader.php';

/** IfwPsn_Vendor_Zend_Controller_Dispatcher_Abstract */
require_once IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Controller/Dispatcher/Abstract.php';
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwPsn_Vendor_Zend_Controller_Dispatcher_Standard extends IfwPsn_Vendor_Zend_Controller_Dispatcher_Abstract
{
    /**
     ...
     * @param string $path
     * @param string $module
     * @return IfwPsn_Vendor_Zend_Controller_Dispatcher_Standard
     */
    ...
    public function setControllerDirectory($directory, $module = null)
    {
        ...
        if (is_string($directory)) {
            ...
            throw new IfwPsn_Vendor_Zend_Controller_Exception('Controller directory spec must be either a string or an array');
        }
    ...
    /**
     * Return the currently set directories for IfwPsn_Vendor_Zend_Controller_Action class
     * lookup
     *
    ...
    /**
     * Returns TRUE if the IfwPsn_Vendor_Zend_Controller_Request_Abstract object can be
     ...
     *
     * @param IfwPsn_Vendor_Zend_Controller_Request_Abstract $action
     * @return boolean
     */
    public function isDispatchable(IfwPsn_Vendor_Zend_Controller_Request_Abstract $request)
    {
        ...
        return IfwPsn_Zend_Loader::isReadable($test);
    }
    ...
    public function dispatch(IfwPsn_Vendor_Zend_Controller_Request_Abstract $request, IfwPsn_Vendor_Zend_Controller_Response_Abstract $response)
    {
        ...
        if (!$this->isDispatchable($request)) {
            ...
            if (!$this->getParam('useDefaultControllerAlways') && !empty($controller)) {
                require_once IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Controller/Dispatcher/Exception.php';
                throw new IfwPsn_Vendor_Zend_Controller_Dispatcher_Exception('Invalid controller specified (' . $controller . ')');
            }
        ...
        if (!($controller instanceof IfwPsn_Vendor_Zend_Controller_Action_Interface) &&
            ...
            throw new IfwPsn_Vendor_Zend_Controller_Dispatcher_Exception(
                'Controller "' . $moduleClassName . '" is not an instance of IfwPsn_Vendor_Zend_Controller_Action_Interface'
            );
        }
     ...
     * @throws IfwPsn_Vendor_Zend_Controller_Dispatcher_Exception if class not loaded
     */
    public function loadClass($className)
    {
        ...
        if (IfwPsn_Zend_Loader::isReadable($loadFile)) {
            ...
            require_once IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Controller/Dispatcher/Exception.php';
            throw new IfwPsn_Vendor_Zend_Controller_Dispatcher_Exception('Cannot load controller class "' . $className . '" from file "' . $loadFile . "'");
        }

        if (!class_exists($finalClass, false)) {
            require_once IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Controller/Dispatcher/Exception.php';
            throw new IfwPsn_Vendor_Zend_Controller_Dispatcher_Exception('Invalid controller class ("' . $finalClass . '")');
        }
     ...
     */
    public function getControllerClass(IfwPsn_Vendor_Zend_Controller_Request_Abstract $request)
    {
        ...
        if ($this->isValidModule($module)) {
            ...
            require_once IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Controller/Exception.php';
            throw new IfwPsn_Vendor_Zend_Controller_Exception('No default module defined for this application');
        }
     ...
     * @return string
     */
    public function getDefaultControllerClass(IfwPsn_Vendor_Zend_Controller_Request_Abstract $request)
    {
        ...
        if ($this->isValidModule($module)) {
            ...
            if (class_exists($default, false)) {
                ...
                if (IfwPsn_Zend_Loader::isReadable($fileSpec)) {
                    $found = true;
     ...
     * @return string
     */
    public function getActionMethod(IfwPsn_Vendor_Zend_Controller_Request_Abstract $request)
    {
