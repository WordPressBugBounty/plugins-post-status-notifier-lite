 ...
 * @subpackage IfwPsn_Vendor_Zend_Controller_Action
 * @copyright  Copyright (c) 2005-2015 Zend Technologies USA Inc. (http://www.zend.com)
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 * @version    $Id: PriorityStack.php 3137090 2024-08-17 17:41:42Z worschtebrot $
 */
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwPsn_Vendor_Zend_Controller_Action_HelperBroker_PriorityStack implements IteratorAggregate, ArrayAccess, Countable
{
     ...
     * @return IfwPsn_Vendor_Zend_Controller_Action_Helper_Abstract
     */
     ...
     *
     * @param IfwPsn_Vendor_Zend_Controller_Action_Helper_Abstract $helper
     * @return IfwPsn_Vendor_Zend_Controller_Action_HelperBroker_PriorityStack
     */
    public function push(IfwPsn_Vendor_Zend_Controller_Action_Helper_Abstract $helper)
    {
    ...
    public function offsetGet($priorityOrHelperName)
    {
        if (!$this->offsetExists($priorityOrHelperName)) {
            ...
            throw new IfwPsn_Vendor_Zend_Controller_Action_Exception('A helper with priority ' . $priorityOrHelperName . ' does not exist.');
        }
    ...
    public function offsetSet($priority, $helper)
    {
        ...
        if (!$helper instanceof IfwPsn_Vendor_Zend_Controller_Action_Helper_Abstract) {
            require_once IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Controller/Action/Exception.php';
            throw new IfwPsn_Vendor_Zend_Controller_Action_Exception('$helper must extend IfwPsn_Vendor_Zend_Controller_Action_Helper_Abstract.');
        }
    ...
    public function offsetUnset($priorityOrHelperName)
    {
        if (!$this->offsetExists($priorityOrHelperName)) {
            require_once IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Controller/Action/Exception.php';
            throw new IfwPsn_Vendor_Zend_Controller_Action_Exception('A helper with priority or name ' . $priorityOrHelperName . ' does not exist.');
        }
