 ...
 * @version   $Id: Yaml.php 3174969 2024-10-24 12:26:47Z worschtebrot $
 */

/**
 * @see IfwPsn_Vendor_Zend_Config
 */
require_once IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Config.php';

/**
 * YAML Adapter for IfwPsn_Vendor_Zend_Config
 *
 * @category  Zend
 * @package   IfwPsn_Vendor_Zend_Config
 * @copyright Copyright (c) 2005-2015 Zend Technologies USA Inc. (http://www.zend.com)
 * @license   http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwPsn_Vendor_Zend_Config_Yaml extends IfwPsn_Vendor_Zend_Config
{
    /**
     ...
     * @return IfwPsn_Vendor_Zend_Config_Yaml
     */
    public function setYamlDecoder($yamlDecoder)
    {
        if (!is_callable($yamlDecoder)) {
            require_once IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Config/Exception.php';
            throw new IfwPsn_Vendor_Zend_Config_Exception('Invalid parameter to setYamlDecoder() - must be callable');
        }
    ...
    public function __construct($yaml, $section = null, $options = false)
    {
        ...
        if (null === $config) {
            // decode failed
            require_once IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Config/Exception.php';
            throw new IfwPsn_Vendor_Zend_Config_Exception("Error parsing YAML data");
        }
        ...
        if (null === $section) {
            ...
            foreach ($section as $sectionName) {
                if (!isset($config[$sectionName])) {
                    require_once IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Config/Exception.php';
                    throw new IfwPsn_Vendor_Zend_Config_Exception(sprintf(
     ...
     * @return array
     * @throws IfwPsn_Vendor_Zend_Config_Exception When $section cannot be found
     */
     ...
     *
     * Until we have IfwPsn_Vendor_Zend_Yaml...
     *
