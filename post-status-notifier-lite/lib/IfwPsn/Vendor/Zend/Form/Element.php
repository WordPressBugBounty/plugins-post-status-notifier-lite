...
/**
 * IfwPsn_Vendor_Zend_Form_Element
 *
 * @category   Zend
 * @package    IfwPsn_Vendor_Zend_Form
 * @subpackage Element
...
class IfwPsn_Vendor_Zend_Form_Element implements IfwPsn_Vendor_Zend_Validate_Interface
{
     ...
     * @return void
     * @throws IfwPsn_Vendor_Zend_Form_Exception if no element name after initialization
     */
    public function __construct($spec, $options = null)
    {
        ...
        } elseif ($spec instanceof IfwPsn_Vendor_Zend_Config) {
            $this->setConfig($spec);
        }

        if (is_string($spec) && is_array($options)) {
            $this->setOptions($options);
        } elseif (is_string($spec) && ($options instanceof IfwPsn_Vendor_Zend_Config)) {
            $this->setConfig($options);
        }

        if (null === $this->getName()) {
            require_once IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Form/Exception.php';
            throw new IfwPsn_Vendor_Zend_Form_Exception('IfwPsn_Vendor_Zend_Form_Element requires each element to have a name');
        }
     ...
     * 
     * @param  IfwPsn_Vendor_Zend_Form_Decorator_Interface $decorator 
     * @return string
     */
    public static function resolveElementId(IfwPsn_Vendor_Zend_Form_Decorator_Interface $decorator)
    {
    ...
    /**
     * Set object state from IfwPsn_Vendor_Zend_Config object
     *
     ...
     *
     * @param  IfwPsn_Vendor_Zend_Translate|null $translator
     * @return IfwPsn_Vendor_Zend_Form_Element
     */
     ...
     * @return void
     */
    protected function _filterValue(&$value, $key = null)
    {
     ...
     * @param  mixed $value
     * @return IfwPsn_Vendor_Zend_Form_Element
     * @throws IfwPsn_Vendor_Zend_Form_Exception for invalid $name values
     */
    public function setAttrib($name, $value)
    {
        ...
        if ('_' == $name[0]) {
            require_once IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Form/Exception.php';
            throw new IfwPsn_Vendor_Zend_Form_Exception(sprintf('Invalid attribute "%s"; must not contain a leading underscore', $name));
        }
    ...
    public function __get($key)
    {
        if ('_' == $key[0]) {
            require_once IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Form/Exception.php';
            throw new IfwPsn_Vendor_Zend_Form_Exception(sprintf('Cannot retrieve value for protected/private property "%s"', $key));
        }
    ...
    public function __call($method, $args)
    {
        if ('render' == substr($method, 0, 6)) {
            ...
            throw new IfwPsn_Vendor_Zend_Form_Element_Exception(sprintf('Decorator by name %s does not exist', $decoratorName));
        }

        require_once IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Form/Element/Exception.php';
        throw new IfwPsn_Vendor_Zend_Form_Element_Exception(sprintf('Method %s does not exist', $method));
    }
     ...
     */
    public function setPluginLoader(IfwPsn_Vendor_Zend_Loader_PluginLoader_Interface $loader, $type)
    {
     ...
     *
     * @param  string|IfwPsn_Vendor_Zend_Validate_Interface $validator
     * @param  bool $breakChainOnFailure
     * @param  array $options
     * @return IfwPsn_Vendor_Zend_Form_Element
     * @throws IfwPsn_Vendor_Zend_Form_Exception if invalid validator type
     */
    public function addValidator($validator, $breakChainOnFailure = false, $options = array())
    {
        if ($validator instanceof IfwPsn_Vendor_Zend_Validate_Interface) {
            ...
            require_once IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Form/Exception.php';
            throw new IfwPsn_Vendor_Zend_Form_Exception('Invalid validator provided to addValidator; must be string or IfwPsn_Vendor_Zend_Validate_Interface');
        }
    ...
    public function addValidators(array $validators)
    {
        foreach ($validators as $validatorInfo) {
            if (is_string($validatorInfo)) {
            ...
            } elseif ($validatorInfo instanceof IfwPsn_Vendor_Zend_Validate_Interface) {
                $this->addValidator($validatorInfo);
                ...
                require_once IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Form/Exception.php';
                throw new IfwPsn_Vendor_Zend_Form_Exception('Invalid validator passed to addValidators()');
            }
        }
     ...
     *
     * @param  string $name
     * @return IfwPsn_Vendor_Zend_Validate_Interface|false False if not found, validator otherwise
     */
    ...
    public function getValidators()
    {
        ...
        foreach ($this->_validators as $key => $value) {
            if ($value instanceof IfwPsn_Vendor_Zend_Validate_Interface) {
    ...
    public function isValid($value, $context = null)
    {
        ...
        if (IfwPsn_Vendor_Zend_Validate_Abstract::hasDefaultTranslator() &&
            !IfwPsn_Vendor_Zend_Form::hasDefaultTranslator())
        {
     ...
     *
     * @param  string|IfwPsn_Vendor_Zend_Filter_Interface $filter
     * @return IfwPsn_Vendor_Zend_Form_Element
     */
    public function addFilter($filter, $options = array())
    {
        if ($filter instanceof IfwPsn_Vendor_Zend_Filter_Interface) {
            ...
            require_once IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Form/Exception.php';
            throw new IfwPsn_Vendor_Zend_Form_Exception('Invalid filter provided to addFilter; must be string or IfwPsn_Vendor_Zend_Filter_Interface');
        }
    ...
    public function addFilters(array $filters)
    {
        foreach ($filters as $filterInfo) {
            if (is_string($filterInfo)) {
            ...
            } elseif ($filterInfo instanceof IfwPsn_Vendor_Zend_Filter_Interface) {
                $this->addFilter($filterInfo);
                ...
                require_once IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Form/Exception.php';
                throw new IfwPsn_Vendor_Zend_Form_Exception('Invalid filter passed to addFilters()');
            }
        }
     ...
     *
     * @param  string $name
     * @return IfwPsn_Vendor_Zend_Filter_Interface
     */
    ...
    public function getFilters()
    {
        ...
        foreach ($this->_filters as $key => $value) {
            if ($value instanceof IfwPsn_Vendor_Zend_Filter_Interface) {
                $filters[$key] = $value;
                continue;
            }
     ...
     *
     * @return null|IfwPsn_Vendor_Zend_View_Interface
     */
    ...
    protected function _loadFilter(array $filter)
    {
        ...
        if (array_key_exists($name, $this->_filters)) {
            require_once IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Form/Exception.php';
            throw new IfwPsn_Vendor_Zend_Form_Exception(sprintf('Filter instance already exists for filter "%s"', $origName));
        }
     ...
     * @return IfwPsn_Vendor_Zend_Validate_Interface
     */
    protected function _loadValidator(array $validator)
    {
        ...
        if (array_key_exists($name, $this->_validators)) {
            require_once IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Form/Exception.php';
            throw new IfwPsn_Vendor_Zend_Form_Exception(sprintf('Validator instance already exists for validator "%s"', $origName));
        }
