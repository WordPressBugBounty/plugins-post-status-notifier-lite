...
/**
 * IfwPsn_Vendor_Zend_Form_Decorator_Label
 *
 * Accepts the options:
...
class IfwPsn_Vendor_Zend_Form_Decorator_Label extends IfwPsn_Vendor_Zend_Form_Decorator_Abstract
{
     ...
     *
     * @param  string $id
     * @return IfwPsn_Vendor_Zend_Form_Decorator_Label
     */
     ...
     * @param  array $args
     * @return mixed
     * @throws IfwPsn_Vendor_Zend_Form_Exception for unsupported methods
     */
    public function __call($method, $args)
    {
        ...
        if (in_array($head, array('get', 'set'))
            ...
            switch ($type) {
                ...
                default:
                    ...
                    throw new IfwPsn_Vendor_Zend_Form_Exception(sprintf('Invalid method "%s" called in Label decorator, and detected as type %s', $method, $type));
            }
            ...
            switch ($head) {
                case 'set':
                    if (0 === count($args)) {
                        require_once IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Form/Exception.php';
                        throw new IfwPsn_Vendor_Zend_Form_Exception(sprintf('Method "%s" requires at least one argument; none provided', $method));
                    }
        ...
        require_once IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Form/Exception.php';
        throw new IfwPsn_Vendor_Zend_Form_Exception(sprintf('Invalid method "%s" called in Label decorator', $method));
    }
