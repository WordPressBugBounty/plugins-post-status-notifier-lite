 ...
 * @version    $Id: Container.php 3137090 2024-08-17 17:41:42Z worschtebrot $
 */

/**
 * IfwPsn_Vendor_Zend_Navigation_Container
 *
 * Container class for IfwPsn_Vendor_Zend_Navigation_Page classes.
 *
 * @category  Zend
 * @package   IfwPsn_Vendor_Zend_Navigation
 * @copyright  Copyright (c) 2005-2015 Zend Technologies USA Inc. (http://www.zend.com)
 * @license   http://framework.zend.com/license/new-bsd     New BSD License
 */
abstract class IfwPsn_Vendor_Zend_Navigation_Container implements RecursiveIterator, Countable
{
    /**
     * Contains sub pages
     *
     * @var IfwPsn_Vendor_Zend_Navigation_Page[]
     */
    ...
    public function addPage($page)
    {
        ...
        if (is_array($page) || $page instanceof IfwPsn_Vendor_Zend_Config) {
            ...
            throw new IfwPsn_Vendor_Zend_Navigation_Exception(
                    ...
                    'IfwPsn_Vendor_Zend_Navigation_Page or IfwPsn_Vendor_Zend_Config, or an array');
        }
     ...
     *
     * @param  IfwPsn_Vendor_Zend_Navigation_Page[]|IfwPsn_Vendor_Zend_Config|IfwPsn_Vendor_Zend_Navigation_Container  $pages  pages to add
     * @return IfwPsn_Vendor_Zend_Navigation_Container                    fluent interface,
     *                                                      returns self
     * @throws IfwPsn_Vendor_Zend_Navigation_Exception                    if $pages is not 
     *                                                      array, IfwPsn_Vendor_Zend_Config or
     *                                                      IfwPsn_Vendor_Zend_Navigation_Container
     */
    public function addPages($pages)
    {
        if ($pages instanceof IfwPsn_Vendor_Zend_Config) {
            $pages = $pages->toArray();
        }

        if ($pages instanceof IfwPsn_Vendor_Zend_Navigation_Container) {
        ...
        if (!is_array($pages)) {
            ...
            throw new IfwPsn_Vendor_Zend_Navigation_Exception(
                    ...
                    'instance of IfwPsn_Vendor_Zend_Config or an instance of ' .
                    'IfwPsn_Vendor_Zend_Navigation_Container');
        }
     ...
     *
     * @param  IfwPsn_Vendor_Zend_Navigation_Page[] $pages               pages to set
     * @return IfwPsn_Vendor_Zend_Navigation_Container  fluent interface, returns self
     */
     ...
     *
     * @return IfwPsn_Vendor_Zend_Navigation_Page[]  array of IfwPsn_Vendor_Zend_Navigation_Page instances
     */
     ...
     *
     * @param  IfwPsn_Vendor_Zend_Navigation_Page|int $page      page to remove, either a page
    ...
    public function removePage($page, $recursive = false)
    {
        ...
        if ($recursive) {
            /** @var IfwPsn_Vendor_Zend_Navigation_Page $childPage */
     ...
     * @return IfwPsn_Vendor_Zend_Navigation_Page|null  matching page or null
     */
     ...
     *                           Default is false.
     * @return IfwPsn_Vendor_Zend_Navigation_Page[] array containing only IfwPsn_Vendor_Zend_Navigation_Page
     *                           instances
     */
     ...
     * @return mixed  IfwPsn_Vendor_Zend_Navigation|array|null    matching page, array of pages
     *                                              or null
     * @throws IfwPsn_Vendor_Zend_Navigation_Exception            if method does not exist
     */
     ...
     *
     * @return IfwPsn_Vendor_Zend_Navigation_Page[]
     */
     ...
     *
     * @return IfwPsn_Vendor_Zend_Navigation_Page       current page or null
     * @throws IfwPsn_Vendor_Zend_Navigation_Exception  if the index is invalid
     */
     ...
     * Implements RecursiveIterator interface.
     *
     * @return IfwPsn_Vendor_Zend_Navigation_Page|null
     */
    #[\ReturnTypeWillChange]
