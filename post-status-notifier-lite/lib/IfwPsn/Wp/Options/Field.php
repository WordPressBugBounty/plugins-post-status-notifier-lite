 ...
 * @version  $Id: Field.php 3137090 2024-08-17 17:41:42Z worschtebrot $
 */
abstract class IfwPsn_Wp_Options_Field
{
    ...
    public function update($value, IfwPsn_Wp_Plugin_Manager $pm)
    {
        return \IfwPsn_Wp_Options::getInstance($pm)->updateOption($this->getId(), $value);
    }
}
