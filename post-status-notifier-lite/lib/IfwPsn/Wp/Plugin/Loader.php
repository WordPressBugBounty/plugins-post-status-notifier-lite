 ...
 * @version   $Id: Loader.php 3137090 2024-08-17 17:41:42Z worschtebrot $
...
class IfwPsn_Wp_Plugin_Loader
{
    ...
    /**
     * @param $pathinfo
     * @param IfwPsn_Wp_Plugin_Loader_Abstract|null $loader
     * @return IfwPsn_Wp_Plugin_Loader_Default|null|object
     */
    public static function load($pathinfo, ?IfwPsn_Wp_Plugin_Loader_Abstract $loader = null)
    {
        try {
