...
class IfwPsn_Wp_Tpl
{
    ...
    public static function factory($options=array())
    {
        ...
        if (is_object($options['twig_loader']) && $options['twig_loader'] instanceof IfwPsn_Vendor_Twig_LoaderInterface) {
            // custom loader object
            $tpl = new IfwPsn_Vendor_Twig_Environment($options['twig_loader'], $twigOptions);
        ...
        require_once dirname(__FILE__) . '/Tpl/Extension/PrintR.php';
        require_once dirname(__FILE__) . '/Tpl/Extension/Text.php';
        require_once dirname(__FILE__) . '/Tpl/Extension/WP.php';
        ...
        $tpl->addExtension(new IfwPsn_Wp_Tpl_Extension_Uniqid());
        $tpl->addExtension(new IfwPsn_Wp_Tpl_Extension_WP());
        $tpl->addExtension(new IfwPsn_Vendor_Twig_Extension_Debug());

        require_once dirname(__FILE__) . '/WunderScript/Extension/Global/Wp.php';
        require_once dirname(__FILE__) . '/WunderScript/Extension/Global/Db.php';

        $tpl->addGlobal( 'wp', new IfwPsn_Wp_WunderScript_Extension_Global_Wp() );
        $tpl->addGlobal( 'db', new IfwPsn_Wp_WunderScript_Extension_Global_Db() );
