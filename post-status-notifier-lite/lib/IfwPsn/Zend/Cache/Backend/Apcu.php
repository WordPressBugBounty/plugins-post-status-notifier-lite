 ...
 * @version    $Id: Apcu.php 3137090 2024-08-17 17:41:42Z worschtebrot $
 */
...
/**
 * @see IfwPsn_Vendor_Zend_Cache_Backend
 */
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwPsn_Zend_Cache_Backend_Apcu extends IfwPsn_Vendor_Zend_Cache_Backend implements IfwPsn_Vendor_Zend_Cache_Backend_ExtendedInterface
{
    /**
     * Log message
     */
    const TAGS_UNSUPPORTED_BY_CLEAN_OF_APCU_BACKEND = 'Coach_IfwPsn_Vendor_Zend_Cache_Backend_Apcu::clean() : tags are unsupported by the Apc backend';
    const TAGS_UNSUPPORTED_BY_SAVE_OF_APCU_BACKEND =  'Coach_IfwPsn_Vendor_Zend_Cache_Backend_Apcu::save() : tags are unsupported by the Apc backend';
    ...
    public function __construct(array $options = array())
    {
        if (!extension_loaded('apcu')) {
            IfwPsn_Vendor_Zend_Cache::throwException('The apcu extension must be loaded for using this backend !');
        }
     ...
     * @return boolean true if no problem
     */
    public function clean($mode = IfwPsn_Vendor_Zend_Cache::CLEANING_MODE_ALL, $tags = array()): bool
    {
        switch ($mode) {
            ...
            case IfwPsn_Vendor_Zend_Cache::CLEANING_MODE_OLD:
                $this->_log("Coach_IfwPsn_Vendor_Zend_Cache_Backend_Apcu::clean() : CLEANING_MODE_OLD is unsupported by the Apc backend");
                break;
