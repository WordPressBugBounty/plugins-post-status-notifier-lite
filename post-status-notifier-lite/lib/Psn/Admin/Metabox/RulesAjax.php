 ...
 * @version   $Id: RulesAjax.php 3174969 2024-10-24 12:26:47Z worschtebrot $
 * @package
 */
...
//        $listTable = new Psn_Admin_ListTable_Rules(IfwPsn_Wp_Plugin_Manager::getInstance('Psn'), array('metabox_embedded' => true, 'ajax' => true));
        $listTable = new Psn_Admin_ListTable_RulesMetabox(IfwPsn_Wp_Plugin_Manager::getInstance('Psn'), array('metabox_embedded' => true, 'ajax' => true));
