 ...
 * @version     $Id: NotificationRule.php 3137090 2024-08-17 17:41:42Z worschtebrot $
    ...
    public function init()
    {
        ...
        $statusValues = array_merge(
            array(
                ...
                'not_scheduled' => __('Not scheduled', 'psn'),
        ...
        add_action('psn_rule_form_after_body', $this);

        /**
         * Recipients
         */
        $recipients = apply_filters('psn_rule_form_recipients_options', array(
        ...
        $this->addElement('textarea', 'cc', array(
            ...
            'description'    => apply_filters('psn_rule_form_description_cc',
        ...
        $this->addElement('textarea', 'bcc', array(
            ...
            'description'    => apply_filters('psn_rule_form_description_bcc',
