 ...
 * @version  $Id: PsnIndexController.php 3137090 2024-08-17 17:41:42Z worschtebrot $
 * @package  IfwPsn_Wp
 */
class PsnIndexController extends PsnApplicationController
{
    ...
    public function indexAction()
    {
        ...
        do_action('psn_admin_overview_before_metabox_left', $metaBoxContainerLeft);
        $metaBoxContainerLeft->addMetabox(new Psn_Admin_Metabox_Rules($this->_pm));
        do_action('psn_admin_overview_after_metabox_left', $metaBoxContainerLeft);

        $metaBoxContainerRight = new IfwPsn_Wp_Plugin_Metabox_Container('column2', $this->_pageHook, 'right');
        do_action('psn_admin_overview_before_metabox_right', $metaBoxContainerRight);
        ...
        do_action('psn_admin_overview_after_metabox_right', $metaBoxContainerRight);
