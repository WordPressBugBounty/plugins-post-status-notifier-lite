...
Tags: post, status, notification, notify, email
...
PSN works great with plugins like **WP Job Manager** ([read more](https://www.ifeelweb.de/2014/666/notify-wp-job-manager-listings-wordpress-plugin-post-status-notifier/)), Calendarize.it ([read more](https://www.ifeelweb.de/2014/748/notify-calendarize-events-wordpress-plugin-post-status-notifier/)), **Crowdfunding by Astoundify** ([read more](https://www.ifeelweb.de/2014/706/notify-payments-crowdfunding-astoundify-post-status-notifier/)) or **Advanced Custom Fields**, just to name a few. The possibilities are endless. Want to **automate your publishing workflow** with [Buffer](https://bufferapp.com/)? No problem!
...
FAQ:
https://docs.ifeelweb.de/post-status-notifier/faq.html

= Features =

Get the [Premium version](https://codecanyon.net/item/post-status-notifier/4809420?ref=ifeelweb) for all features
...
* Premium version: [HTML emails / mail templates](https://docs.ifeelweb.de/post-status-notifier/mail_templates.html)
* Premium version: [Mail queue / deferred sending](https://docs.ifeelweb.de/post-status-notifier/mailqueue.html)
...
* Premium version: **Conditional template syntax** ([Manual](https://docs.ifeelweb.de/post-status-notifier/conditional_templates.html))
* Premium version: Extensible ([Manual](https://docs.ifeelweb.de/post-status-notifier/extending_index.html))
...
* Premium version: [Dynamic recipients](https://docs.ifeelweb.de/post-status-notifier/dynamic_recipients.html)
* Premium version: [Late execution](https://docs.ifeelweb.de/post-status-notifier/options.html#late-execution) to support frontend submission plugins as well as possible
* Premium version: [Rule trigger limitations](https://docs.ifeelweb.de/post-status-notifier/limitations.html)
...
[Comment-Source](https://codecanyon.net/item/post-status-notifier/discussion/4809420)
...
- Added: New placeholders for post title and content diffs: [post_diff_title], [post_diff_content] (https://docs.ifeelweb.de/post-status-notifier/content_diffs.html) (Premium)
- Fixed: Compatibility fix for PHP 7
...
If you find any bugs please use the comments on the [plugin's homepage](https://www.ifeelweb.de/contact/). Please also contact me for feature requests and ideas how to improve this plugin. Any other reactions are welcome too of course.
